...
def run_migrations(args, options, executor_codename, tenant, allow_atomic=True):
    ...
    schema_name = tenant.schema_name if isinstance(tenant, TenantModel) else tenant
...
class MigrationExecutor(object):
    ...
    def run_migrations(self, tenants):
        ...
        for idx, tenant in enumerate(tenants):
            schema_name = tenant.schema_name if isinstance(tenant, get_tenant_model()) else tenant
